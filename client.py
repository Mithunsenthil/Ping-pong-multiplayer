...
def redrawWindow(win, game):
    if not (game.connected()):
        pygame.draw.rect(win, WHITE, (0, 0, 150, 600))
        pygame.draw.rect(win, GREEN, (150, 0, 150, 600))
        pygame.draw.rect(win, RED, (300, 0, 150, 600))
        pygame.draw.rect(win, DARK_BLUE, (450, 0, 150, 600))
        ...
        win.fill((37, 37, 37))
        pygame.draw.rect(win, WHITE, (300, 300, 235, 235))
        pygame.draw.rect(win, GREEN, (65, 300, 235, 235))
        pygame.draw.rect(win, RED, (300, 65, 235, 235))
        pygame.draw.rect(win, DARK_BLUE, (65, 65, 235, 235))
...
def main():
    ...
    while run:
        ...
        if game.get_winner() is not None:
            ...
            text = font.render("OMG!!! " + game.get_winner() + " lost the match", True, (255, 255, 255))
