...
class Game:
    def __init__(self, id):
        self.id = id
        self.players = [Player(120, 120, DARK_BLUE), Player(480, 120, GREEN),
                        Player(120, 480, RED), Player(480, 480, WHITE)]
        self.ready = False
        self.puck = Puck(300, 300, WHITE)  
        self.winner = None
    ...
    def resetWent(self):
        self.players = [Player(120, 120, WHITE), Player(480, 120, RED),
                        Player(120, 480, GREEN), Player(480, 480, DARK_BLUE)]
